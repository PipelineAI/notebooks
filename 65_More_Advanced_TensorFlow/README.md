...
1. Simple Linear Model ([Notebook](01_Simple_Linear_Model.ipynb)

2. Convolutional Neural Network ([Notebook](02_Convolutional_Neural_Network.ipynb)

3. Pretty Tensor ([Notebook](03_PrettyTensor.ipynb)

3-B. Layers API ([Notebook](03B_Layers_API.ipynb)

4. Save & Restore ([Notebook](04_Save_Restore.ipynb)

5. Ensemble Learning ([Notebook](05_Ensemble_Learning.ipynb)

6. CIFAR-10 ([Notebook](06_CIFAR-10.ipynb)

7. Inception Model ([Notebook](07_Inception_Model.ipynb)

8. Transfer Learning ([Notebook](08_Transfer_Learning.ipynb)

9. Video Data ([Notebook](09_Video_Data.ipynb)
...
11. Adversarial Examples ([Notebook](11_Adversarial_Examples.ipynb)

12. Adversarial Noise for MNIST ([Notebook](12_Adversarial_Noise_MNIST.ipynb)

13. Visual Analysis ([Notebook](13_Visual_Analysis.ipynb)

13-B. Visual Analysis for MNIST ([Notebook](13B_Visual_Analysis_MNIST.ipynb)

14. DeepDream ([Notebook](14_DeepDream.ipynb)

15. Style Transfer ([Notebook](15_Style_Transfer.ipynb)

16. Reinforcement Learning ([Notebook](16_Reinforcement_Learning.ipynb)

17. Estimator API ([Notebook](17_Estimator_API.ipynb)

18. TFRecords & Dataset API ([Notebook](18_TFRecords_Dataset_API.ipynb) 
